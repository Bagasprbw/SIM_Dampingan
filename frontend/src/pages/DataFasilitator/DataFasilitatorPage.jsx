                    ...
                    {isLoading ? (
                        ...
                        <>
                            ...
                            <div className="lg:hidden flex flex-col pb-24 bg-[#F0F2F8] min-h-screen gap-3">
                                ...
                                <div className="flex flex-row items-center gap-2 w-full h-[34px]">
                                    <div className="flex-1 h-full">
                                        <FilterDropdown
                                            ...
                                            labelKey="name"
                                            onChange={(v) => { setProvinsiFilter(v); setKabupatenFilter(null); setKecamatanFilter(null); setPage(1); }}
                                            className="!h-full !rounded-[14px] !border-[#E5E7EB] !text-[11px]"
                                        />
                                    </div>
                                    <button 
                                        onClick={() => setIsManageBidangOpen(true)}
                                        className="h-full px-3 bg-[#0080C5] text-white rounded-[14px] flex items-center justify-center gap-1.5 shadow-sm whitespace-nowrap"
                                    >
                                        <Settings size={13} />
