...
const DashboardPage = () => {
            ...
            <div className="flex flex-col gap-6 font-['Poppins'] min-h-screen">
                ...
                <div className="grid grid-cols-2 gap-4 md:gap-5">
                    <div className="bg-white p-4 md:p-6 rounded-[16px] md:rounded-2xl border border-slate-100 flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
                        ...
                        <div className="flex flex-col">
                            <span className="text-[#9298B0] text-[10px] md:text-xs font-normal tracking-tight">Total Dampingan</span>
                    ...
                    <div className="bg-white p-4 md:p-6 rounded-[16px] md:rounded-2xl border border-slate-100 flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
                        ...
                        <div className="flex flex-col">
                            <span className="text-[#9298B0] text-[10px] md:text-xs font-normal tracking-tight">Total Grup</span>
                            <span className="text-[#0A0F1E] text-xl md:text-[32px] font-extrabold tracking-tight leading-none mt-1">118</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
                    ...
                    <div className="bg-white p-5 md:p-6 rounded-[16px] md:rounded-2xl border border-slate-100 flex flex-col gap-4 shadow-[0_2px_10px_rgba(0,0,0,0.02)] h-[320px] md:h-[340px]">
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center">
                            ...
                            <div className="grid grid-cols-2 gap-x-2 md:gap-x-4 gap-y-1 w-full mt-2">
                                {fasilitatorPieData.map((item, i) => (
                                    <div key={i} className="flex items-center gap-1.5">
                                        <div className="w-2 h-2 rounded-full shrink-0" style={{ backgroundColor: item.color }} />
                                        <span className="text-[9px] md:text-[10px] text-slate-500 font-medium truncate">{item.name}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    <div className="bg-white p-5 md:p-6 rounded-[16px] md:rounded-2xl border border-slate-100 flex flex-col gap-4 shadow-[0_2px_10px_rgba(0,0,0,0.02)] h-[320px] md:h-[340px]">
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center gap-2 md:gap-3 text-center">
                            <div className="w-8 h-8 md:w-10 md:h-10 bg-slate-50 rounded-lg flex items-center justify-center"><Info size={18} className="text-slate-300 md:w-[20px] md:h-[20px]" /></div>
                            <h4 className="text-slate-400 text-[11px] md:text-xs font-bold">Tidak ada kegiatan</h4>
                            <p className="text-[#9298B0] text-[9px] md:text-[10px] font-medium leading-relaxed px-4">Kegiatan tidak ditemukan pada bulan ini.</p>
                        </div>
                    </div>
                ...
                <div className="bg-white rounded-[16px] md:rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-slate-100 flex flex-col">
                    ...
                    <div className="flex flex-col">
                        {[1,2,3].map((_, iIdx) => (
                            <div key={iIdx} className={`p-3 md:p-4 flex items-center justify-between hover:bg-gray-50 transition-colors ${iIdx !== 2 ? 'border-b border-slate-50' : 'rounded-b-2xl'}`}>
                                <div className="flex items-center gap-2.5 md:gap-3">
                                    <div className="w-8 h-8 md:w-9 md:h-9 bg-[#0080C5] text-white rounded-lg flex items-center justify-center text-[10px] md:text-[11px] font-bold">PJ</div>
                                    <div className="flex flex-col">
                                        <span className="text-[#0A0F1E] text-[10px] md:text-[11px] font-semibold">Fasilitator {user?.name || 'Siti Aminah'}</span>
                                        <span className="text-[#9298B0] text-[9px] md:text-[10px] font-normal truncate max-w-[150px] sm:max-w-none">menambahkan data kegiatan baru</span>
                                    </div>
                                </div>
                                <div className="flex items-center gap-1.5 md:gap-2 shrink-0">
                                    <div className="w-4 h-4 md:w-5 md:h-5 bg-[#43DE20]/20 rounded-full flex items-center justify-center">
                                        <div className="w-2 h-2 md:w-2.5 md:h-2.5 rounded-full bg-[#43DE20]" />
                                    </div>
                                    <span className="text-[#C4C8D8] text-[9px] md:text-[10px] font-normal">1 jam lalu</span>
                                </div>
                            </div>
                        ))}
                    </div>
    ...
    const renderAdminDashboard = () => {
        const stats = [
            { label: 'Total Admin Daerah', value: '118', icon: <Users size={20} className="text-[#8B5CF6] md:w-[24px] md:h-[24px]" />, bgColor: 'bg-[#8B5CF6]/10' },
            { label: 'Total Fasilitator', value: '118', icon: <UserPlus size={20} className="text-[#0080C5] md:w-[24px] md:h-[24px]" />, bgColor: 'bg-[#0080C5]/10' },
            { label: 'Total Dampingan', value: '118', icon: <Users size={20} className="text-[#F59E0B] md:w-[24px] md:h-[24px]" />, bgColor: 'bg-[#F59E0B]/10' },
            { label: 'Total Grup Dampingan', value: '118', icon: <LayoutGrid size={20} className="text-[#10B981] md:w-[24px] md:h-[24px]" />, bgColor: 'bg-[#10B981]/10' },
        ];
        ...
        const activities = [
            { 
                title: 'Admin Daerah', 
                items: [
                    { id: 'PJ', name: 'Provinsi Jawa Tengah', action: 'menambahkan data fasilitator', time: '1 jam lalu', statusColor: 'bg-[#43DE20]' },
                    { id: 'PJ', name: 'Provinsi Jawa Tengah', action: 'menambahkan data fasilitator', time: '1 jam lalu', statusColor: 'bg-[#43DE20]' },
                    { id: 'PJ', name: 'Provinsi Jawa Tengah', action: 'menambahkan data fasilitator', time: '1 jam lalu', statusColor: 'bg-[#43DE20]' },
                ]
            },
            ...
            <div className="flex flex-col gap-5 md:gap-8 font-['Poppins']">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
                    ...
                    <div className="bg-white p-5 md:p-6 rounded-[16px] md:rounded-2xl border border-slate-100 flex flex-col gap-4 shadow-[0_2px_10px_rgba(0,0,0,0.02)] h-[320px] md:h-80">
                        ...
                        <div className="flex items-center gap-1">
                            <span className="text-[#9298B0] text-[10px] md:text-xs font-normal">Total Kegiatan Bulan ini: </span>
                            <span className="text-[#0A0F1E] text-[10px] md:text-[11px] font-semibold">0</span>
                        </div>
                        <div className="flex-1 flex flex-col items-center justify-center gap-3 md:gap-4 text-center">
                            <div className="w-8 h-8 md:w-10 md:h-10 bg-slate-50 rounded-full md:rounded-lg flex items-center justify-center border border-slate-200/50"><Info size={16} className="text-slate-400 md:w-[20px] md:h-[20px]" /></div>
                            <p className="text-[#9298B0] text-[10px] md:text-xs font-medium px-4 md:px-8 leading-relaxed">Kegiatan tidak ditemukan pada bulan ini.</p>
                        </div>
                    </div>
