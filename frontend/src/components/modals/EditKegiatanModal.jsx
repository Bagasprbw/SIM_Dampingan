            ...
            <div className="relative bg-white w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300">
                ...
                <div className="px-6 py-5 border-b border-gray-100 flex justify-between items-center bg-white">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-base font-bold text-slate-900">Edit Kegiatan Dampingan</h3>
                            <p className="text-[11px] text-slate-400 font-medium tracking-tight">Perbarui informasi kegiatan yang telah dicatat</p>
                        </div>
                    </div>
                    <button 
                        onClick={onClose}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <select 
                                    defaultValue="1"
                                    className="w-full h-12 pl-12 pr-10 bg-slate-50 border-none rounded-xl focus:ring-2 focus:ring-[#0080C5]/20 focus:bg-white transition-all text-sm font-medium outline-none appearance-none cursor-pointer"
                                >
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                >
                                    ...
                                    <option value="1">{data?.fasilitator}</option>
                                </select>
                                <ChevronDown size={18} className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none" />
                            </div>
                        </div>
                        ...
                        <div className="md:col-span-2 space-y-2">
                            ...
                            <textarea 
                                rows="3"
                                defaultValue="Melakukan pembinaan teknis budidaya ikan lele dan pemberian pakan yang efisien kepada anggota grup dampingan."
