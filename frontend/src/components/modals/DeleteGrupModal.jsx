            ...
            <div className="relative w-full max-w-[460px] bg-white rounded-2xl shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] overflow-hidden animate-in fade-in zoom-in duration-200">
                ...
                <div className="h-20 px-6 border-b border-gray-100 flex items-center justify-between bg-white">
                    <div className="flex items-center gap-3 text-left">
                        ...
                        <div>
                            <h3 className="text-neutral-950 text-base font-bold leading-tight">Hapus Data Grup Dampingan</h3>
                ...
                <div className="p-5 space-y-3">
                    ...
                    <div className="p-4 bg-red-50 rounded-xl border border-red-100 text-left space-y-3">
                        <p className="text-slate-700 text-xs font-normal leading-5">
                            Apakah Anda yakin ingin menghapus data grup dampingan berikut?
                        </p>
                    ...
                    <div className="flex gap-3 text-left">
                        ...
                        <p className="text-amber-800 text-xs font-normal leading-5">
                            Seluruh data yang berkaitan dengan grup dampingan ini akan ikut terhapus secara permanen dari sistem.
                        </p>
                    </div>
...
export default DeleteGrupModal;
